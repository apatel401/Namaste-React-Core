...
**1. What is Emmet?**
```
Emmet is powerful built-in vs code extension which we can use during production to bring in boiler plate codes. It has many shortcuts which will reduce our work of repitive work. For Ex. writing   `ul>li*20>a` will give me unordered list with 20 li and a inside it.
```
